...
public class RuntimeInstrumentation {
    ...
    public static <DS> long timeFunction(int currentSize, DS ds, BiConsumer<Integer, DS> function) {
        RuntimeCounter.NUM_CALLS = 0;
        //long startTime = System.nanoTime();
        function.accept(currentSize, ds);
        //long endTime = System.nanoTime();
        return RuntimeCounter.NUM_CALLS;//endTime - startTime;
    }

    public static <DS> ComplexityType getEmpiricalComplexity(Function<Integer, DS> provideDSOfSize, BiConsumer<Integer, DS> functionToTest, int numberOfDoubles) {
        ...
        for (int currentSize = 1; currentSize < maxSize; currentSize *= 2) {
            ...
            for (int i = 0; i < ITERATIONS; i++) {
                ...
                totalTime += timeFunction(currentSize, ds, functionToTest);
            }
    ...
    public static <DS> void assertAtMost(String whatIsBeingTested, ComplexityType expected, Function<Integer, DS> provideDSOfSize, BiConsumer<Integer, DS> functionToTest, int numberOfDoubles) {
